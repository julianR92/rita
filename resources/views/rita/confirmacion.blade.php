        ...
        <div class="row mt-2">
            ...
            <div class="col-md-12">
                ...
                <div class="alert-success-govco alert alert-dismissible fade show animate__animated animate__bounceInRight" aria-label="Alerta: caso de éxito">
                    ...
                    <p>Apreciado Ciudadano, su solicitud ha sido recibida satisfactoriamente para consultar el estado de su denuncia tenga en cuenta el siguiente numero de radicado: <strong> {{session('radicado_id')}}</strong></p>
                    <p><strong>Duracion:</strong> 15 dias Habiles</p>
                  </div>


            </div>
            <div class="col-md-4">
                <button style="font-size:15px;" type="button" class="btn btn-round btn-middle" name="consultar"><a href="{{URL::route('rita.finalizar')}}">Finalizar</a></button>
...
<script>
    setTimeout(function() {
      window.location.href = '/rita/finalizar';
   }, 120000);
</script>
@else
