...
<head>
    ...
    <link href="{{ asset('library/BoostrapFile/css/fileinput.css') }}" media="all" rel="stylesheet"
        type="text/css" />
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
                <div class="container-fluid">
                    <a href="https://www.bucaramanga.gov.co/" target="_blank"
                        ...
                        <img src="{{ asset('img/ALCALDIA.png') }}" class="img_alcaldia img-fluid float-left mt-2"
            ...
            <div class="footer page__footer footer-white footer-blue">
                <div class="container">
                    <div class="footer-container" id="footer-container">
                        ...
                        <div
                            ...
                            <div class="item-footer border-right col-md-2">
                                <div class="d-flex justify-content-center">
                                    <a class="navbar-brand" href="https://www.gov.co/" style="padding:0!important;">
                                        <img src="https://cdn.www.gov.co/assets/images/logo.png" height="40"
                                            alt="Logo Gov.co" />
                                    </a>
                                </div>
                                <div class="d-flex justify-content-center mt-3">
                                    <a class="navbar-brand" href="https://www.gov.co/" style="padding:0!important;">
                                        <img src="{{ asset('img/logo_colombia.png') }}" height="100px"
                                            alt="Logo Gov.co" />
                                    </a>
                                </div>
                            </div>
                            <div class="item-footer col-md-5 border-right">
                                <div class="px-3">
                                    ...
                                    <p>Horario de Atención: Lunes a viernes de 6:00 a.m. a 02:00 p.m. jornada contínua
                                    </p>
                                    <br>
                                    <div class="row">
                                        <div class="col-md-12">
                        ...
                        <div class="container-fluid pt-5 mb-0 pb-0">
                           <div class="row">
                            ...
                            <div class="col-md-10">
                                <p class="font-weight-bold" style="text-align:center;"><a class="text-white"
                                        ...
                                        target="_blank">Política web y condiciones de uso |</a>&nbsp; <a
                                        class="text-white"
                                        ...
                                        target="_blank">Plan de uso de redes sociales |</a>&nbsp; <a
                                        class="text-white"
                                        ...
                                        href="https://www.bucaramanga.gov.co/wp-content/uploads/2021/08/PLAN-DE-COMUNICACIONES-2020-2023.pdf"
                                        target="_blank">Política de seguridad de la información |</a>&nbsp; <a
                                        class="text-white"
                                        href="https://www.bucaramanga.gov.co/politicas-de-privacidad/"
                                        target="_blank">Uso y monitoreo de la página web |</a>&nbsp; <a
                                        class="text-white" href="https://www.gov.co/home/mapa-del-sitio"
                                        target="_blank">Mapa del sitio</a> </p>
                            </div>
                            <div class="col-md-1"></div>
                        </div>
                     </div>
